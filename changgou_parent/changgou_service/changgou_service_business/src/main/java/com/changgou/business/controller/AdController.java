...
//    public PageResult findPages(@RequestBody Ad ad,@PathVariable("currentPage") int currentPage,@PathVariable("pageSize") int pageSize ){
//
//        return adService.findPages(ad,currentPage,pageSize);
//
//    }
